...
export default function Header() {
  ...
  // Manejar envío del buscador
  const handleSearchSubmit = (e) => {
    e.preventDefault();
    const query = terminoBusqueda.trim();
    if (query) {
      navigate(`/catalogo?busqueda=${encodeURIComponent(query)}`);
    } else {
      navigate("/catalogo");
    }
    setTerminoBusqueda("");
        ...
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse" id="navbarContent">
            ...
            <ul className="navbar-nav mb-2 mb-lg-0 central-menu">
              ...
              <li className="nav-item dropdown">
                <Link className="nav-link dropdown-toggle" to="/comunidad">Comunidad</Link>
                <ul className="dropdown-menu">
                    ...
                    <div className="dropdown">
                      ...
                      {showClickDropdown && (
                        <ul className="dropdown-menu show dropdown-menu-start">
                          ...
                          <li><Link className="dropdown-item" to="/NuestraHistoria">Revisa nuestra Historia</Link></li>
                        </ul>
                      )}
                    </div>
                  </li>
